...
public class CarFacadeTest {
    ...
    public void setUp() {
        ...
        carFacade = new CarFacade(carRepository, carMapper, categoryMapper, transmissionTypeMapper, carApiClient);
    }
    ...
    public void getDataBaseCarList() {
        ...
        // When
        List<CarDto> result = carFacade.getDataBaseCarList();
    ...
    public void getAPICarList() throws Exception {
        ...
        // When
        List<CarDto> result = carFacade.getAPICarList();
    ...
    public void getAvailableCars() {
        ...
        // When
        List<CarDto> result = carFacade.getAvailableCars();
    ...
    public void getCarById() throws CarNotFoundException {
        ...
        // When
        CarDto result = carFacade.getCarById(carId);
    ...
    public void getCarByModel() throws CarNotFoundException {
        ...
        // When
        CarDto result = carFacade.getCarByModel(model);
    ...
    public void saveCar() {
        ...
        // When
        CarDto result = carFacade.saveCar(carDto);
